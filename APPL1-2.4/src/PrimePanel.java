...
public class PrimePanel extends JPanel {
    ...
    private JScrollPane primeListScrollPane;
    ...
    public PrimePanel() {
        ...
        primeListScrollPane = new JScrollPane(primeList);
        primeListScrollPane.setVerticalScrollBarPolicy(JScrollPane.VERTICAL_SCROLLBAR_ALWAYS);
            ...
            try {
                ...
                if (num < 2)
                    ...
                    for (int i = 3; i <= num; i += 2) {
                        ...
                        int j = 3;
                        while (Math.sqrt(j) < i && !foundDivisor) {
                            if (i % j == 0)
                                foundDivisor = true;
                            else
                                j++;
                ...
                primeList.setText("Unable to output prime list: " + e.getMessage());
            }
        }
    }
}